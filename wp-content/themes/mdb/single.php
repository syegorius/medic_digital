...
echo get_left_side_articles($ids);
...
function get_article(){
    ...
    $html.='<div class="a_ad_s">
        ...
        <div class="article_social left">
            ...
            <div class="left" style="background-image:url(\''.get_template_directory_uri().'/img/fb.png\')"><a href="https://www.facebook.com/sharer/sharer.php?u=example.org" target="_blank">&nbsp;</a></div>
            <div class="clear"></div>
        </div>
        <div class="clear"></div>
    </div>';
...
function get_article_content(){
    ...
    $first_add_block="<!-- /50454183/MedicDigital-Mobile -->
        <div class='ad'><div id='div-gpt-ad-".get_option('dfp_id')."-0' style='height:160px; width:646px;'>
        <script>
    ...
    $second_add_block="<!-- /50454183/MedicDigital-Mobile -->
        <div class='ad'><div id='div-gpt-ad-".get_option('dfp_id')."-1' style='height:540px; width:646px;'>
        <script>
        googletag.cmd.push(function() { googletag.display('div-gpt-ad-".get_option('dfp_id')."-0'); });
        </script>
        </div></div>";
